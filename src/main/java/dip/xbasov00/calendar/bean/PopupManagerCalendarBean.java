 ...
 * Document      : PopupManagerCalendarBean.java
...
@Named
@SessionScoped
public class PopupManagerCalendarBean extends PopupManager implements Serializable {

    private static final long serialVersionUID = 4378302055308585388L;


    /**
     * Attribute key in portlet specific session representing view.
     */
    private static final String ATTR_VIEW = "PopupManagerCalendarBean:view";
    
    
    /**
     * Attribute key in portlet specific session representing title.
     */
    private static final String ATTR_TITLE = "PopupManagerCalendarBean:title";
